...
[Ссылка на bash скрипт](https://github.com/EvgeniyaBalanyuk/shvirtd-example-python/blob/main/bash.sh)

[Ссылка на форк-репозиторий](https://github.com/EvgeniyaBalanyuk/shvirtd-example-python)
